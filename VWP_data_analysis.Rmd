...
setwd("~/Documents/RPTU/WS 24:25/LB_Linguistics/Lab_modality_data_2024")


# rmarkdown::render("VWP data analysis (Lab Rotation Linguistics).Rmd", output_format = "html_document")
```
...
```{r load data}
vwp = read.csv("vwp_recheck_data.csv")
